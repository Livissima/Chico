class Sige:
    ...
    def credenciais(self):
        # path = r'C:\Users\livia\PycharmProjects\GO_Office\credenciais.txt'
        path = r'C:\Users\meren\PycharmProjects\GO_Office\credenciais.txt'
        with open(path, 'r') as leitor:
            linhas = leitor.readlines()
        return {
            'id' : linhas[2].replace('\n', ''),
            'senha' : linhas[3].replace('\n', '')
        }
